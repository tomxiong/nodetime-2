...
Nodetime.prototype.profile = function(opts) {
  ...
  if(this.headless) {
    console.log('YOU ARE USING NODETIME IN HEADLESS MODE. THIS NODETIME AGENT IS DESIGNED AND OPTIMIZED TO BE USED WITH NODETIME.COM SERVICE ONLY. USE OF THE AGENT WITH OTHER SERVICE OR SERVER IS NOT SUPPORTED.');
  }
