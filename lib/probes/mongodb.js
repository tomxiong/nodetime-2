...
module.exports = function(nt, obj) {
  ...
  function monitorCollection(host, port, dbName, collName) {
    ...
    if(colls[address] || ++collsCount > 250) return;
  ...
  function loadStats(coll) {
    var mClient = new obj.Db(coll.dbName, new obj.Server(coll.host, coll.port, {'auto_reconnect': false, 'poolSize': 1}), {safe: false});
